      ...
      <div className="flex justify-end mt-auto">
        {demoLink && (
          <a
            ...
            className="bg-dark-slate text-slate-50 hover:bg-slate-900 hover:drop-shadow-lg focus:bg-slate-900 focus:drop-shadow-lg focus:outline-1 outline-current rounded-md my-2 mx-1 px-2 py-1 text-lg hover:cursor-pointer"
          >
            demo
          </a>
        )}
        {codebaseLink && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-slate-50 text-dark-slate font-semibold hover:bg-white hover:drop-shadow-md hover:text-slate-900 focus:bg-white focus:drop-shadow-md hover:text-slate-900 border-2 border-dark-slate focus:outline-1 outline-current rounded-md my-2 mx-1 px-2 py-1 text-lg hover:cursor-pointer"
          >
            codebase
          </a>
        )}
