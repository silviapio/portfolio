...
export const AboutSection = ({ openDialogFunction }) => {
  return (
    <section id="aboutSection" className="mt-10 mb-8 px-4 md:mx-12 2xl:mx-36">
      ...
      <details>
        ...
        <ul className="ml-10 sm:text-lg list-disc">
          ...
          <li>
            ...
            some programming theory wouldn't hurt. I'm taking CS50x, Harvard's course for CS majors, and I'm enjoying it
            very much.
          </li>
          <li>
      ...
      <details>
        ...
        <ul className="ml-10 sm:text-lg list-disc">
          ...
          <li>
            Documenting and explaining: I enjoy keeping notes of what I learn, and helping others to understand concepts
            I have already clear. It puts my learning at 10x speed.
          </li>
          <li>
            ...
            Internet just a little bit more awesome (quoting the great Kevin Powell)!
          </li>
        </ul>
      </details>
      <p className="mt-4 px-2 whitespace-pre-line sm:text-lg font-semibold">TL;DR</p>
      <p className="mt-1 px-2 whitespace-pre-line sm:text-lg">
